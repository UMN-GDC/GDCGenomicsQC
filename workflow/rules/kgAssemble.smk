rule kgAssemble:
    ...
    output:
        ...
        highcovPgen = ancient(REF / "1000G_highcoverage" / "1000G_highCoveragephased.pgen"),
        highcovPvar = ancient(REF / "1000G_highcoverage" / "1000G_highCoveragephased.pvar"),
        highcovPsam = ancient(REF / "1000G_highcoverage" / "1000G_highCoveragephased.psam"),
        ...
        fastafai = ancient(REF / "Homo_sapiens.GRCh38.dna.primary_assembly.fa.fai"),
    input:
        vcf = expand(REF / "1000G_highcoverage" / "1kGP_high_coverage_Illumina.chr{CHR}.filtered.SNV_INDEL_SV_phased_panel.vcf.gz", CHR = CHROMOSOMES),
