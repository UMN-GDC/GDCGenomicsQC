...
**See also:** [](tutorial_ancestry_classification.md) for using reference data.
...
* - File
  - Description
* - ``1000G_highCoveragephased.pgen``
  - Full merged genotype file
* - ``1000G_highCoveragephased.pvar``
  - Variant information
* - ``1000G_highCoveragephased.psam``
  - Sample information with ancestry
* - ``1000G_highCoveragephased.pruned.pgen``
  - LD-pruned, unrelated samples
```
...
see [](tutorial_ancestry_classification.md).
...
- [](tutorial_qc_pipeline.md) - Run QC on your samples (uses REF for ancestry QC)
- [](tutorial_ancestry_classification.md) - Classify ancestry using the reference panel
...
- [](genomics.md) - Technical details on reference-based methods
