checkpoint kgMeta:
    ...
    output:
        ...
        gr38fastagz = temp(REF / "Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz"),
        gr38fasta = REF / "Homo_sapiens.GRCh38.dna.primary_assembly.fa",
        mapgz = temp(REF / "1000G_highcoverage" / "hg38map.txt.gz"),
        map = REF / "1000G_highcoverage" / "hg38map.txt",
