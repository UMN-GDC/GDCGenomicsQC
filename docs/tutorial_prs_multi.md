...
**Prerequisite tutorial**: [](tutorial_prs.md) (single-ancestry methods)
...
For single-ancestry PRS methods, see [](tutorial_prs.md).
...
**See also:** [](tutorial_prs.md) for single-ancestry methods, [](tutorial_qc_pipeline.md) for genotype prep.
...
1. **Portability comparison**: Compare multi-ancestry R² vs single-ancestry (from [](tutorial_prs.md)) applied to non-EUR targets
...
- [](tutorial_prs.md) - Single-ancestry PRS methods
...
- [](genomics.md) - Technical details on multi-ancestry PRS methodology
